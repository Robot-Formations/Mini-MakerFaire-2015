...
void setup()
{
  ...
  //compass.m_min = (LSM303::vector<int16_t>){ -3426,  -3777, +17450};
  //compass.m_max = (LSM303::vector<int16_t>){ +1547,  +1737, +23347};
/*
  compass.m_max.x = -214;
  compass.m_max.y = -1025;
  compass.m_min.x = -1904;
  compass.m_min.y = -2770;
*/
